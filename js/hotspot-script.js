  ...
  const initializeProject = () => {
    ...
    if (initialImageID) {
      const selectedOption = $(
        `#hotspots-image-select option[value='${initialImageID}']`
      );
...
$("#item-select").on("change", function () {
  ...
  const productHtml = `<div class="chosen-product" data-id="${selectedOption.val()}" data-url="${imageUrl}">
